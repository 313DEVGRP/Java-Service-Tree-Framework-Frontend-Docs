...
export declare const FunctionalityModules: (typeof CacheModule | DynamicModule | typeof ErrorModule | typeof MetricsModule)[];
...
export declare function buildAppModule(): {
    new (): {};
};
