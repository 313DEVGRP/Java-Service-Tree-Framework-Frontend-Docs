...
export declare class UserService {
    ...
    createUser_without_verification(data: CreateUserInput): Promise<{
        name: string;
        id: string;
        email: string;
        emailVerifiedAt: Date | null;
    ...
    updateUser(id: string, data: Omit<Partial<Prisma.UserCreateInput>, 'id'>, select?: Prisma.UserSelect): Promise<{
        password: string | null;
        subscriptions: {
            id: number;
            userId: string;
