...
import { EventEmitter, MailService, MemberQuotaExceeded, MutexService, TooManyRequest } from '../../../fundamentals';
...
export declare class WorkspaceResolver {
    ...
    invite(user: CurrentUser, workspaceId: string, email: string, permission: Permission, sendInviteMail: boolean): Promise<string | TooManyRequest | MemberQuotaExceeded>;
