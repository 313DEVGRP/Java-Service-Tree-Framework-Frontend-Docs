 ...
 * })
 */
export declare class Runtime implements OnModuleInit {
    private readonly db;
    ...
    list(module?: AppRuntimeConfigModules): Promise<any>;
    set<K extends keyof FlattenedAppRuntimeConfig, V = FlattenedAppRuntimeConfig[K]>(key: K, value: V): Promise<any>;
