...
function buildAppModule() {
    ...
    factor
        ...
        // graphql server only
        .useIf(config => config.flavor.graphql, ServerConfigModule, GqlModule, StorageModule, WorkspaceModule, FeatureModule, QuotaModule)
        // self hosted server only
        .useIf(config => config.isSelfhosted, CustomSetupModule, ServeStaticModule.forRoot({
