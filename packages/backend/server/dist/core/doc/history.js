...
import { Config, DocHistoryNotFound, DocNotFound, metrics, OnEvent, WorkspaceNotFound, } from '../../fundamentals';
...
DocHistoryManager = DocHistoryManager_1 = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [Config, Object, QuotaService])
], DocHistoryManager);
